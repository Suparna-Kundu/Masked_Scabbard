...
uint32_t InnerProdEnc(uint8_t ciphertext[SABER_BYTES_CCA_DEC], const uint8_t pk[SABER_INDCPA_PUBLICKEYBYTES], uint16_t sp[SABER_N], const uint8_t m[SABER_KEYBYTES], int compare);
