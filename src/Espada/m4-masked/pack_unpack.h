...
//     void POLVECmu2BS(uint8_t bytes[SABER_L * SABER_N / 4], const uint16_t data[SABER_L][SABER_N]);
//     void BS2POLVECmu(const uint8_t bytes[SABER_L * SABER_N / 4], uint16_t data[SABER_L][SABER_N]);
